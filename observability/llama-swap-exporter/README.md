...
6. llamacpp_n_past_max_total
7. llamacpp_n_busy_slots_per_decode_total
8. llamacpp_prompt_tokens_seconds
9. llamacpp_predicted_tokens_seconds
10. llamacpp_requests_processing
11. llamacpp_requests_deferred
